...
:startLogin
call :getLoginStatus
if "%login_running%" == "false" (
    wt -w 0 new-tab --title "LOGIN" cmd /k "cd /d D:\_SmokeWorld\SmokeWorld_rAthena && logserv.bat %restart_mode%"
...
:startChar
call :getCharStatus
if "%char_running%" == "false" (
    wt -w 0 new-tab --title "CHAR" cmd /k "cd /d D:\_SmokeWorld\SmokeWorld_rAthena && charserv.bat %restart_mode%"
...
if "%web_running%" == "false" (
    wt -w 0 new-tab --title "WEB" cmd /k "cd /d D:\_SmokeWorld\SmokeWorld_rAthena && webserv.bat %restart_mode%"
...
:startMap
call :getMapStatus
if "%map_running%" == "false" (
    wt -w 0 new-tab --title "MAP" cmd /k "cd /d D:\_SmokeWorld\SmokeWorld_rAthena && mapserv.bat %restart_mode%"

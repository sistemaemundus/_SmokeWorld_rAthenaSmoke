...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant2("bSmokeGearProg", SP_SMOKE_GEAR_PROG);
	...
	// EMUNDUS
	export_constant(SC_SMOKE_GODLIKE);
	export_constant(SC_SMOKE_PHOENIX);
	export_constant(SC_SMOKE_AZUR);
	export_constant(SC_SMOKE_ASCENSION);
	export_constant(SC_SMOKE_ASCENDED);
	export_constant(SC_SMOKE_AURA);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	export_constant(EFST_SMOKE_GODLIKE);
	export_constant(EFST_SMOKE_PHOENIX);
	export_constant(EFST_SMOKE_AZUR);
	export_constant(EFST_SMOKE_ASCENSION);
	export_constant(EFST_SMOKE_ASCENDED);
	export_constant(EFST_SMOKE_AURA);
	...
	// EMUNDUS ESTEVE AQUI
	export_constant(IG_smw_rune_essence_life);
	export_constant(IG_smw_rune_essence_fire);
	export_constant(IG_smw_rune_essence_ice);
	export_constant(IG_smw_rune_essence_death);
	export_constant(IG_smw_rune_essence_ancestral);
	export_constant(IG_smw_rune_essence_divine);
	export_constant(IG_smw_rune_essence_primo);

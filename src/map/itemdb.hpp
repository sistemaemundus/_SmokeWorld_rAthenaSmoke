...
enum e_random_item_group {
	...
	IG_SELECT_DEC_PACK2,
	IG_SELECT_DEC_PACK3,
	IG_smw_rune_essence_life,
	IG_smw_rune_essence_fire,
	IG_smw_rune_essence_ice,
	IG_smw_rune_essence_death,
	IG_smw_rune_essence_ancestral,
	IG_smw_rune_essence_divine,
	IG_smw_rune_essence_primo,
...
struct s_item_combo {
	...
	script_code *script;
	std::string script_text; // novo campo, para estudo - Emundus
	uint16 id;
	uint8 smoke_status = 0; // 0 = false | 1 true
...
struct s_item_reform_base{
	...
	bool consumeItemSuccess; // <-- Consumir Item no sucesso? by alephSystem Emundus
};
